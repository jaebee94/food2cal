class argHandler(dict):
    ...
    def setDefaults(self):
        ...
        self.define('pbLoad', 'ai/darkflow/built_graph/my-tiny.pb', 'path to .pb protobuf file (metaLoad must also be specified)')
        self.define('metaLoad', 'ai/darkflow/built_graph/my-tiny.meta', 'path to .meta file generated during --savepb that corresponds to .pb file')
